...
{
    public class PortalHint : SceneItem
    {

        public PortalHint(Vector2 POS, Vector2 SCALE)
            : base("2d\\Misc\\PortalHint", POS, new Vector2(750, 250) * SCALE, new Vector2(1, 1), SCALE)
        {
            drawLayer = 0;
        }
